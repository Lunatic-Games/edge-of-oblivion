@icon("res://Assets/art/logic-tree/triggers/heal.png")
class_name LT_OnEntityHealed
...
@export var output_heal_amount: LT_IntVariable
...
func trigger(source_item: Item, source_entity: Entity, source_tile: Tile,
	...
	if output_heal_amount != null:
		output_heal_amount.value = heal_amount
