...
@export var stop_condition: StopCondition = StopCondition.NoCondition
...
func tile_matches_stop_condition(tile: Tile) -> bool:
	match stop_condition:
		StopCondition.NoCondition:
			return false
		StopCondition.AnyOccupant:
			return tile.occupant != null
		StopCondition.PlayerEntity:
			return (tile.occupant as Player) != null
		StopCondition.EnemyEntity:
